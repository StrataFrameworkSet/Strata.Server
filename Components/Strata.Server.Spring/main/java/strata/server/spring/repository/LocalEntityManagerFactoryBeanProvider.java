...
public
class LocalEntityManagerFactoryBeanProvider
    implements Provider<LocalEntityManagerFactoryBean>
{
    private final LocalEntityManagerFactoryBean factory;
    private final static Set<String> requiredProperties = getRequiredProperties();

    @Inject
    public
    LocalEntityManagerFactoryBeanProvider(IConfiguration configuration)
    {
    ...
    protected LocalEntityManagerFactoryBean
    configureFactory(
        IConfiguration                configuration,
        HibernateJpaVendorAdapter     adapter,
